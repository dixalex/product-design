...
1. **Skill is a process skill, not a reference library.** Mimics `superpowers:brainstorming` and sibling `product-architecture`. Gates between layers; terminates in a handoff brief. Source: spec `2026-04-26-visual-design-skill.md § 3.1`.
